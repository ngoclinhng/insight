...
#
# INPUTS:
#   CURRENT_INSIGHT_COMPILE_OPTIONS: List of currently enabled Insight compile
...
#
#   INSIGHT_CONFIG_OUTPUT_DIRECTORY: Path to output directory in which to save
#                                    the configured config.h file. Typically,
#                                    this will be <src>/include/insight/internal.
...
function(CREATE_INSIGHT_CONFIG
  ...
  if (NOT EXISTS "${INSIGHT_CONFIG_OUTPUT_DIRECTORY}")
    message(STATUS "Creating configured Insight config.h output directory: "
      "${INSIGHT_CONFIG_OUTPUT_DIRECTORY}")
    file(MAKE_DIRECTORY "${INSIGHT_CONFIG_OUTPUT_DIRECTORY}")
  endif()
  if (EXISTS "${INSIGHT_CONFIG_OUTPUT_DIRECTORY}" AND
      NOT IS_DIRECTORY "${INSIGHT_CONFIG_OUTPUT_DIRECTORY}")
    message(FATAL_ERROR "Insight Bug: Specified "
      "INSIGHT_CONFIG_OUTPUT_DIRECTORY: "
  ...
  file(READ ${INSIGHT_CONFIG_IN_FILE} INSIGHT_CONFIG_IN_CONTENTS)
  string(REGEX MATCHALL "@[^@ $]+@"
    ALL_CONFIGURABLE_INSIGHT_OPTIONS "${INSIGHT_CONFIG_IN_CONTENTS}")
  ...
  foreach (INSIGHT_OPTION ${ALL_CONFIGURABLE_INSIGHT_OPTIONS})
    ...
    if (OPTION_ENABLED GREATER -1)
      message(STATUS "Enabling ${INSIGHT_OPTION} in Insight config.h")
  ...
  if (CURRENT_INSIGHT_COMPILE_OPTIONS)
    message(FATAL_ERROR "Insight Bug: CURRENT_INSIGHT_COMPILE_OPTIONS "

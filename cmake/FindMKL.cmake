...
# ---[ Options
option(MKL_USE_SINGLE_DYNAMIC_LIBRARY
  "Use MKL single dynamic library interface" ON)

if (NOT MKL_USE_SINGLE_DYNAMIC_LIBRARY)
  option(MKL_USE_STATIS_LIBS "Use MKL static library." OFF)
endif()

if (NOT MKL_USE_SINGLE_DYNAMIC_LIBRARY)
  option(MKL_MULTI_THREADED "Use MKL multi-threading" ON)
endif()
